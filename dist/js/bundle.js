...
/***/ function(module, exports, __webpack_require__) {
	...
	let config = {
	    pushState: false,
	    apiUrl: '//api.monochrome-yeh.com/cv/',
	    userId: '572bf03bc072118c363f5dc2',
	    ga: {
	        enabled: true,
	        id: 'UA-76384660-1'
	    },
	...
	if (false) {
	    ...
	    config.apiUrl = 'http://api.dev.com/cv/';
	    config.userId = '56fdba7fc46988bb268b4579';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Skill_Details = __webpack_require__(280);
	
	var _Skill_Details2 = _interopRequireDefault(_Skill_Details);
	...
	var updatePage = null;
	if (false) {
					var Update = require('views/update/Update');
					updatePage = _react2.default.createElement(_reactRouter.Route, { path: 'update', component: Update });
	}
	...
	var history = (0, _reactRouterRedux.syncHistoryWithStore)(_config2.default.pushState === true ? _reactRouter.browserHistory : _reactRouter.hashHistory, store);
	
	module.exports = (0, _reactDom.render)(_react2.default.createElement(
					...
					_react2.default.createElement(
									...
									_react2.default.createElement(
													...
													_react2.default.createElement(_reactRouter.Route, { name: 'index', path: 'index/:hash', component: _Index2.default }),
													updatePage
									),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(16),
	    ...
	    Footer = __webpack_require__(261),
	...
	module.exports = React.createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        var wow = new WOW({
	            ...
	            offset: Math.floor(window.innerHeight / 5)
	    ...
	    render: function render() {
	        ...
	        var fbRoot = '';
	        if (config.fb.enabled === true) {
	            fbRoot = React.createElement('div', { id: 'fb-root' });
	...
	module.exports = React.createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        ...
	        $('#navbar').on('activate.bs.scrollspy', function (e) {
	            var _target = $('a[data-target]', e.target);
	            var _hashName = _target.attr('href');
	            window.history.replaceState(null, null, _hashName);
	            // if (config.ga.enabled === true && !_.isEmpty(_hashName)) {
	            //     ga('send', 'pageview', _hashName);
	            // }
	        });
	    },
	    componentWillUpdate: function componentWillUpdate() {
	        $('#navbar').off('activate.bs.scrollspy');
	    },
	    render: function render() {
	        return React.createElement(
	            'div',
	            { className: 'navbar-wrapper', 'data-spy': 'affix', id: 'm-affix', 'data-offset-top': '60' },
	            React.createElement(
	                'div',
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'button',
	                            { type: 'button', className: 'navbar-toggle collapsed pull-right', 'data-toggle': 'collapse', 'data-target': '#navbar', 'aria-expanded': 'false', 'aria-controls': 'navbar' },
	                            React.createElement(
	                                'span',
	                                { className: 'sr-only' },
	                                '您觸發了導覽列'
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                ...
	                                React.createElement(_reactRouter.IndexLink, { to: "/", 'data-target': '#intro' })
	                            ),
	                            React.createElement(
	                                'li',
	                                ...
	                                React.createElement(
	                                    _reactRouter.Link,
	                                    { to: '/index/about', 'data-target': '#about' },
	                                    React.createElement(
	                                        'div',
	                                        null,
	                                        '關於我'
	                            ...
	                            React.createElement(
	                                ...
	                                React.createElement(
	                                    _reactRouter.Link,
	                                    { to: '/index/skill', 'data-target': '#skill' },
	                                    React.createElement(
	                                        'div',
	                                        null,
	                                        '技能'
	                            ...
	                            React.createElement(
	                                ...
	                                React.createElement(
	                                    _reactRouter.Link,
	                                    { to: '/index/experience', 'data-target': '#experience' },
	                                    React.createElement(
	                                        'div',
	                                        null,
	                                        '經歷'
	                            ...
	                            React.createElement(
	                                ...
	                                React.createElement(
	                                    _reactRouter.Link,
	                                    { to: '/index/portfolio', 'data-target': '#portfolio' },
	                                    React.createElement(
	                                        'div',
	                                        null,
	                                        '作品集'
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (window) {
	    ...
	    (function (d, s, id) {
	        ...
	        js.id = id;
	        js.src = "//connect.facebook.net/" + config.fb.language + "/sdk.js";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _parallax = __webpack_require__(265);
	...
	var _experience = __webpack_require__(274);
	
	var _experience2 = _interopRequireDefault(_experience);
	
	var _portfolio = __webpack_require__(277);
	
	var _portfolio2 = _interopRequireDefault(_portfolio);
	
	var _skills = __webpack_require__(278);
	
	var _skills2 = _interopRequireDefault(_skills);
	
	var _interesting = __webpack_require__(279);
	
	var _interesting2 = _interopRequireDefault(_interesting);
	...
	var Index = function (_Component) {
	    ...
	    _createClass(Index, [{
	        ...
	        value: function componentDidUpdate() {
	            var anchor = this.props.params.hash;
	            if (typeof anchor !== 'undefined') {
	                var link = $('#' + anchor);
	                $('html, body').stop(true).animate({
	                    scrollTop: link.offset().top - 49
	                }, 1000, 'easeOutExpo');
	            } else {
	                $('html, body').stop(true).animate({
	                    scrollTop: 0
	        ...
	        value: function componentDidMount() {
	            ...
	            this.req = request.get(_config2.default.apiUrl + 'profile/' + _config2.default.userId).end(function (err, res) {
	                if (err || !res.ok) {
	                    alert('Oh no! error');
	                } else {
	                    _this2.setState({
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'content' },
	                _react2.default.createElement(_parallax2.default, { data: this.state.data }),
	                _react2.default.createElement(_about2.default, { data: this.state.data }),
	                _react2.default.createElement(_skills2.default, { data: this.state.data.skills }),
	                _react2.default.createElement(_experience2.default, { data: this.state.data.experience }),
	                _react2.default.createElement(_portfolio2.default, { data: this.state.data.portfolio }),
	                _react2.default.createElement(_interesting2.default, null)
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	//                    <a href="#"><i className="fa fa-wrench"></i> How it works</a>
	...
	module.exports = React.createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        ...
	        var imgHeight = this.refs.img.naturalHeight;
	        var caption = $(this.refs.caption);
	        $('#intro .parallax').parallax();
	        $('#intro  .parallax-container').css({
	            'height': windowHeight
	        });
	
	        if (imgHeight > windowHeight) {
	            $(this.refs.parallax).css({
	                'bottom': windowHeight - imgHeight
	            });
	        }
	
	        caption.css({
	            'top': Math.floor(windowHeight / 2 - caption.height() / 2)
	        });
	    },
	    render: function render() {
	        return React.createElement(
	            'section',
	            { id: 'intro', className: 'section-block root-sec' },
	            React.createElement(
	                'div',
	                { className: 'parallax-container' },
	                React.createElement(
	                    'div',
	                    { className: 'cover parallax', ref: 'parallax' },
	                    React.createElement('img', { src: '/dist/images/m_banner_04.jpg', ref: 'img' })
	                ),
	                React.createElement(
	                    'div',
	                    { className: 'parallax-caption', ref: 'caption' },
	                    React.createElement(
	                        'h1',
	                        null,
	                        'Hello! I\'m ',
	            ...
	            React.createElement(
	                _reactRouter.Link,
	                { to: '/index/about', 'data-target': '#about', className: 'btn-floating btn-large button-middle call-to-about section-call-to-btn btn-show animated' },
	                React.createElement('i', { className: 'fa fa-angle-down fa-3x' })
	            )
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        (0, _reactDom.render)(React.createElement(Modal, { title: '自我介紹', content: this.state.introductionDetail, button: 'OK', desc: '' }), document.getElementById('modal'));
	    },
	    ...
	    handleOpenModal: function handleOpenModal(e) {
	        ...
	        var self = this;
	        var request = __webpack_require__(268);
	        self.req = request.get(config.apiUrl + 'introduction-detail/' + config.userId).end(function (err, res) {
	            if (err || !res.ok) {
	                alert('Oh no! error');
	            } else {
	                self.setState({
	                    introductionDetail: res.body.introduction_detail
	                });
	            }
	        });
	        if (config.ga.enabled === true) {
	            ga('send', 'event', {
	                eventCategory: 'Modal',
	                eventAction: 'click',
	                eventLabel: 'introduction-detail'
	            });
	        }
	    },
	    render: function render() {
	        //<h5><span>Phone :</span> {_.map(this.props.data.tel, function(i) {return i + ' ';})}</h5>
	        return React.createElement(
	            'section',
	            { id: 'about', className: 'section-block grey lighten-5 padd-tb-60 root-sec' },
	            React.createElement(
	                'div',
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement('p', { dangerouslySetInnerHTML: {
	                                    __html: this.props.data.introduction
	                                } }),
	                            React.createElement(
	                                'button',
	                                { 'data-target': 'modal-widget', onClick: this.handleOpenModal, className: 'modal-trigger waves-effect waves-light btn-large app-main-bg white-text waves-effect waves-light' },
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'div',
	                            { className: 'person-img wow fadeIn animated' },
	                            React.createElement('img', { className: 'z-depth-1', src: '/dist/images/person.jpg', alt: '' })
	                        )
	                    ),
	                    React.createElement(
	                        'div',
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                ...
	                                ' ',
	                                parseInt(new Date().getFullYear()) - this.props.data.age
	                            ),
	                            React.createElement(
	                                'h5',
	                                null,
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                ...
	                                React.createElement(
	                                    ...
	                                    React.createElement(
	                                        'a',
	                                        { target: '_blank', href: 'https://github.com/monochrome-yeh', className: 'btn-floating waves-effect waves-light white' },
	                                ...
	                                React.createElement(
	                                    ...
	                                    React.createElement(
	                                        'a',
	                                        { target: '_blank', href: 'https://tw.linkedin.com/in/monochromeyeh', className: 'btn-floating waves-effect waves-light white' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Modal = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            'div',
	            { id: 'modal-widget', className: 'modal modal-fixed-footer' },
	            React.createElement(
	                'div',
	                ...
	                React.createElement('p', { className: 'markdown', dangerouslySetInnerHTML: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(16);
	var marked = __webpack_require__(275);
	var fn = __webpack_require__(276);
	var TimelineBlock = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                { className: 'vertical-timeline-icon app-main-bg white-text z-depth-1' },
	                React.createElement('i', { className: 'fa fa-briefcase' })
	            ),
	            React.createElement(
	                'div',
	                { className: "vertical-timeline-content z-depth-1 wow " + this.props.animate },
	                React.createElement(
	                    'h2',
	                    null,
	                    this.props.company
	                ...
	                React.createElement('p', { dangerouslySetInnerHTML: {
	                        __html: fn.nl2br(this.props.content, false)
	                    } }),
	                React.createElement(
	                    'span',
	                    { className: 'vertical-date wow fadeIn' },
	                    React.createElement(
	                        'small',
	                        null,
	                        this.props.period
	...
	module.exports = React.createClass({
	    ...
	    render: function render() {
	        var i = 0,
	            dataList = this.props.data.map(function (item, index) {
	            i++;
	            var animate = i % 2 ? 'slideInLeft' : 'slideInRight';
	
	            return React.createElement(TimelineBlock, { animate: animate, key: index, company: item.company, title: item.title, content: item.content, period: item.period });
	        });
	        return React.createElement(
	            'section',
	            { id: 'experience', className: 'grey lighten-5 padd-tb-60' },
	            React.createElement(
	                'div',
	                { className: 'container wow fadeInUp' },
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'div',
	                            { className: 'clearfix section-head education-text' },
	                            React.createElement(
	                                'h2',
	                                { className: 'title' },
	                                '工作經歷'
	                            ...
	                            React.createElement(
	                                ...
	                                '工作的十年裏，從後端、前端到全端(棧)，學到最多的就是如何讓自己享受技術的學習~'
	                            )
	                        )
	                    ),
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                'div',
	                                { id: 'vertical-timeline', className: 'vertical-container center-orientation light-timeline' },
	                                dataList
	                            )
	                        )
	                    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    editInterrupt: function editInterrupt() {
	        window.onbeforeunload = function () {
	            //if(){
	            return "You haven't finished your information yet. Do you want to leave without finishing?";
	            //}
	        };
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SingleCardBox = React.createClass({
	    displayName: 'SingleCardBox',
	
	    getDefaultProps: function getDefaultProps() {
	        return {
	            img: '/dist/images/no_img.png'
	        };
	    },
	    componentDidMount: function componentDidMount() {
	        $('.tooltipped').tooltip({
	    ...
	    render: function render() {
	        return React.createElement(
	            'div',
	            { className: "single-card-box wow fadeIn " + this.props.grid },
	            React.createElement(
	                'div',
	                { className: 'card' },
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'h2',
	                        { className: 'left-align card-title-top' },
	                        this.props.period
	                    ),
	                    React.createElement(
	                        'div',
	                        { className: 'valign-wrapper card-img-wrap' },
	                        React.createElement('img', { className: 'activator', src: _.isEmpty(this.props.img) || typeof this.props.img === 'undefined' ? '/dist/images/no_img.png' : this.props.img, alt: this.props.project, style: {
	                                'width': 128
	                            } })
	                    )
	                ),
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'span',
	                        { 'data-tooltip': this.props.project, className: 'card-title activator app-main-text tooltipped', 'data-position': 'top', 'data-delay': '50' },
	                        this.props.project,
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'div',
	                        { className: 'rev-title-wrap' },
	                        React.createElement(
	                            'span',
	                            { 'data-tooltip': this.props.project, className: 'card-title app-main-text tooltipped', 'data-position': 'top', 'data-delay': '50' },
	                            this.props.project,
	...
	module.exports = React.createClass({
	    ...
	    handleDataLoad: function handleDataLoad(e) {
	        e.preventDefault();
	        this.setState({
	            temporary: '資料待補齊...'
	        });
	    ...
	    componentDidMount: function componentDidMount() {},
	    render: function render() {
	        var dataView = this.props.data.map(function (item, index) {
	            return React.createElement(SingleCardBox, {
	                key: index,
	        ...
	        return React.createElement(
	            'section',
	            { id: 'portfolio', className: 'grey lighten-5' },
	            React.createElement(
	                'div',
	                { className: 'app-main-bg padd-tb-120 portfolio-top wow fadeInUp' },
	                React.createElement(
	                    'div',
	                    { className: 'container' },
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                'ul',
	                                { className: 'inline-menu clearfix portfolio-category hidden', id: 'portfolio-msnry-sort' },
	                                React.createElement(
	                                    'li',
	                                    { className: 'active' },
	                                    React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                'a',
	                                { onClick: this.handleDataLoad, id: 'portfolio-item-loader', href: '#', className: 'btn-floating btn-large waves-effect waves-light app-main-bg' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Skills = React.createClass({
	    ...
	    //  $(this.refs.pb).find('.progress-bar').each(function(index, item) {
	    //      var $item = $(item),
	    //          percent = $item.attr('aria-valuenow') + '%';
	    ...
	    render: function render() {
	        var rateCss = {
	            ...
	            rankList = ['暸解', '熟悉', '掌握', '精通', '專家'],
	            colorList = ['progress-bar-danger', 'progress-bar-warning', 'progress-bar-success', 'progress-bar-info', ''],
	            rank = 'unknown',
	            _base = 100 / rankList.length,
	            rate = 1,
	            color = 'progress-bar-danger';
	
	        if (!isNaN(this.props.rate) && (this.props.rate > 0 || this.props.rate <= 100)) {
	            rate = this.props.rate;
	        }
	        rank = rankList[Math.ceil(rate / _base) - 1];
	        color = colorList[Math.ceil(rate / _base) - 1];
	        return React.createElement(
	            'div',
	            { key: this.props.key, className: 'col-sm-6' },
	            React.createElement(
	                'div',
	                null,
	                React.createElement(
	            ...
	            React.createElement(
	                'div',
	                { className: 'progress progress-small' },
	                React.createElement('div', { className: "progress-bar wow slideInLeft " + color, role: 'progressbar', ref: 'pb', 'aria-valuenow': rate, 'aria-valuemin': '0', 'aria-valuemax': '100', style: rateCss })
	            )
	        );
	    }
	});
	...
	module.exports = React.createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        (0, _reactDom.render)(React.createElement(Modal, { title: '技能詳細應用', content: marked(this.state.skillDetails), button: 'OK', desc: '' }), document.getElementById('modal'));
	        $('.modal-trigger').leanModal();
	    },
	    componentDidUpdate: function componentDidUpdate() {
	        (0, _reactDom.render)(React.createElement(Modal, { title: '技能詳細應用', content: marked(this.state.skillDetails), button: 'OK', desc: '' }), document.getElementById('modal'));
	    ...
	    handleOpenModal: function handleOpenModal(e) {
	        ...
	        var self = this;
	        var request = __webpack_require__(268);
	        self.req = request.get(config.apiUrl + 'skill-details/' + config.userId).end(function (err, res) {
	            if (err || !res.ok) {
	                alert('Oh no! error');
	            } else {
	                self.setState({
	                    skillDetails: res.body.skill_details
	                });
	            }
	        });
	        if (config.ga.enabled === true) {
	            ga('send', 'event', {
	                eventCategory: 'Modal',
	                eventAction: 'click',
	                eventLabel: 'skill-details'
	            });
	        }
	    },
	    render: function render() {
	        var dataView = this.props.data.map(function (item, index) {
	            return React.createElement(Skills, { rate: item.rate, name: item.name, key: index });
	        });
	
	        return React.createElement(
	            'section',
	            { id: 'skill', className: 'app-main-bg section-block padd-tb-60' },
	            React.createElement(
	                'div',
	                { className: 'container wow fadeInUp' },
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'div',
	                        { className: 'col-sm-12 col-md-3 animated fadeIn' },
	                        React.createElement(
	                            'div',
	                            ...
	                            React.createElement(
	                                'p',
	                                { className: 'regular-text white-text' },
	                                '這邊包含了前端、後端及伺服器端的技能項目掌握度；評分項目僅供參考。'
	                            )
	                        )
	                    ),
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                ...
	                                React.createElement(
	                                    'button',
	                                    { 'data-target': 'modal-widget', onClick: this.handleOpenModal, className: 'modal-trigger btn app-second-bg waves-effect waves-light' },
	                                    '暸解更多細節...'
	                                )
	                            )
	                        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        ...
	        var imgHeight = this.refs.img.naturalHeight;
	        var caption = $(this.refs.caption);
	        $('#interesting .parallax').parallax();
	        $('#interesting  .parallax-container').css({
	            'height': 300
	        });
	
	        caption.css({
	            'top': 300 / 2 - Math.floor(caption.innerHeight() / 2)
	        });
	    },
	    render: function render() {
	        return React.createElement(
	            'section',
	            { id: 'interesting', className: 'section-block root-sec' },
	            React.createElement(
	                'div',
	                { className: 'parallax-container' },
	                React.createElement(
	                    'div',
	                    { className: 'dark parallax', ref: 'parallax' },
	                    React.createElement('img', { src: '/dist/images/panorama_01.jpg', ref: 'img' })
	                ),
	                React.createElement(
	                    'div',
	                    { className: 'parallax-caption padd-tb-60', ref: 'caption' },
	                    React.createElement(
	                        'h4',
	                        null,
	                        '我喜歡'
	                    ...
	                    React.createElement(
	                        'p',
	                        null,
	                        '我喜歡旅遊、美食、籃球和唱歌，它帶給我更多色彩...'
	                    ),
	                    React.createElement('div', { className: 'fb-share-button', 'data-href': 'http://monochrome-yeh.github.io', 'data-layout': 'button_count', 'data-mobile-iframe': 'true' })
	                )
	            ),
	            React.createElement(
	                _reactRouter.IndexLink,
	                { to: '/', className: 'btn-floating btn-large button-middle call-to-about section-call-to-btn btn-show animated' },
	                React.createElement('i', { className: 'fa fa-angle-up fa-3x' })
	            )
	        );
	    }
	});
	...
	module.exports = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                { className: 'parallax-container h300' },
	                React.createElement(
	                    'div',
	                    { className: 'parallax' },
	                    React.createElement('img', { src: '/dist/images/m_banner_01.jpg' })
	                )
	            ),
	            React.createElement(
	                'div',
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                'div',
	                                { className: 'card-content' },
	                                React.createElement('div', { className: 'flow-text', dangerouslySetInnerHTML: {
	                                        __html: marked(this.state.data.skill_details || '')
	                                    } })
	                            )
	                        )
	                    )
